                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('product.update',$product->id)}}" enctype='multipart/form-data'>
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="NAME" name="name" value="{{$product->name}}">
                        </div>
                        
                        <div class="input-group">
                            <input class="input--style-1" min="0" type="number" placeholder="PRICE" name="price" value="{{$product->price}}">
                        </div>
                            <!--
                            <div class="col-2">
                                <div class="input-group">
                             ...
                             -->
                        <div class="input-group">
                            <input class="input--style-1" type="number" min="0" placeholder="SIZE" name="size" value="{{$product->size}}">
                        </div>
                        ...
                        <div class="input-group">
                            <div class="rs-select2 js-select-simple select--no-search ">
                                ...
                                <select name="tag_id[]" multiple width="20px">
                                    @foreach ($tags as $tag)
                                    @foreach ($product->tag as $product_tag)
